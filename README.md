...
| 模块 | 功能说明 | 优势 |
| :--- | :--- | :--- |
| **✨ Sugiyama 拓扑自动分层排布** | 拓扑分层排序 + 重心减叉 + 包围盒动态避障 | 一键消除卡片堆叠重合，按因果流自适应规整舒展，350ms 平滑运动过渡 |
| **📑 章节目录与光效跳转** | PDF 原生大纲树递归解析与定位 | 一键展开目录大纲，平滑精准跳转目标页并触发科技感光效聚焦 (Halo Jump) |
| **📂 文献解耦与断点无损记忆** | 自由上传多篇 PDF/Markdown 论文 | 会话级文献绑定，抽屉折叠与跨课题切换零跳动，精确还原上次阅读偏移 |
| **☀️ 浅色模式与主题持久化** | 高对比 Slate / Indigo 日间学术配色 | 深浅模式一键秒切，KaTeX 公式黑白锐利分明，LocalStorage 长效记忆 |
